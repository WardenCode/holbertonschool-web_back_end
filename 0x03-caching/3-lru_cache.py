...
class LRUCache(BaseCaching):
    ...
    using the Cache replacement policies - LRU
    """

    def __init__(self):
        """
        Construsctor of LRUCache Class
    ...
    def put(self, key, item):
        ...
        the cache replacement Policy of LRU.
        ...
        if (self.cache_data.get(key)):
            ...
            self.recently_used.insert(0, moved_value)
        else:
        ...
        if (len_cache_data > self.MAX_ITEMS):
            eliminated = self.recently_used.pop()
