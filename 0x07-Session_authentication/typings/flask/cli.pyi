...
def find_best_app(script_info, module): # -> Flask:
...
def find_app_by_string(script_info, module, app_name): # -> Flask:
...
def prepare_import(path): # -> LiteralString:
    """Given a filename this will try to calculate the python path, add it
    to the search path and return the actual module name that is expected.
    """
    ...

def locate_app(script_info, module_name, app_name, raise_if_not_found=...): # -> Flask | None:
    ...
...
pass_script_info = ...
def with_appcontext(f): # -> (__ctx: Unknown, *args: Unknown, **kwargs: Unknown) -> Unknown:
...
class AppGroup(click.Group):
    ...
    """
    def command(self, *args, **kwargs): # -> (f: Unknown) -> Command:
    ...
    def group(self, *args, **kwargs): # -> ((...) -> Any) -> Group:
        """This works exactly like the method of the same name on a regular
...
class FlaskGroup(AppGroup):
    ...
    def get_command(self, ctx, name): # -> Command | None:
        ...
...
class CertParamType(click.ParamType):
    ...
    def convert(self, value, param, ctx): # -> Any | SSLContext:
        ...
...
@pass_script_info
def run_command(info, host, port, reload, debugger, eager_loading, with_threads, cert, extra_files): # -> None:
...
@with_appcontext
def routes_command(sort, all_methods): # -> None:
