...
class EnvironBuilder(werkzeug.test.EnvironBuilder):
    ...
    def json_dumps(self, obj, **kwargs): # -> Any:
...
def make_test_environ_builder(*args, **kwargs): # -> EnvironBuilder:
...
class FlaskClient(Client):
    ...
    @contextmanager
    def session_transaction(self, *args, **kwargs): # -> Generator[Any, None, None]:
    ...
    def __enter__(self): # -> Self@FlaskClient:
        ...
...
class FlaskCliRunner(CliRunner):
    ...
    def invoke(self, cli=..., args=..., **kwargs): # -> Result:
